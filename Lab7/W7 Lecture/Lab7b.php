...
<form action=<?=$_SERVER['PHP_SELF']?> method="post">
    ...
    <tr>
        ...
        <th></th>
    <?php
    //Generate a 30 by 13 table
    $cols = 13;
    $rows = 30;
    for($j = 1; $j < $cols; $j++){

        echo "<th>". date("M",mktime(0,0,0,$j,1,2022)) ."</th>";
    }
    ...
    ?>
        ...
        <tbody>
        <?php
    foreach ($pressure as $index => $row) {
//        $bgColor = ($index % 2 == 0) ? "aliceblue" : "white"; // Even rows are blue, odd rows are white
//        echo "<tr style='background-color: $bgColor;'>";
//        echo "<td style='font-weight: bold'>$index</td>"; // Display the row number
        echo "<tr>";
        echo "<td>$index</td>";
    ...
    <p style="font-size: 25px; font-family:'Times New Roman'">kPa = hPa / 10<br>
        atm = hPa / 1013.25<br>
        mmHg = atm * 760.0<br>
        psi = atm / 14.70</p>
</form>
...
<footer class="footer mt-auto py-3 bg-dark">
    <div class="container">
        <span class="text-muted cont">&copy; Erin Ng 2025</span>
    </div>
</footer>
